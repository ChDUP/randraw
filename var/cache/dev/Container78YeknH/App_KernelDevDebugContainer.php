...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))->createConnection(['driver' => $this->getEnv('resolve:DB_CONNECTION'), 'host' => $this->getEnv('resolve:DB_HOST'), 'port' => $this->getEnv('resolve:DB_PORT'), 'dbname' => $this->getEnv('resolve:DB_DATABASE'), 'user' => $this->getEnv('resolve:DB_USERNAME'), 'password' => $this->getEnv('resolve:DB_PASSWORD'), 'driverOptions' => [], 'defaultTableOptions' => []], $a, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
